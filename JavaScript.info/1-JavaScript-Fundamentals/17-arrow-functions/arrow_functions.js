...
/* This arrow funtion is a shorter form of:
 ...
 * named 'a' and 'b'. Upon the execution, it evaluates the expression 'a + b' and returns 
 * the result.
 * 
...
let double = n => n * 2;
// roughly the same as: let double = function(n) {return n * 3};
 ...
 * 
 * They are very convenient for simple one-line actions, when we’re just 
 * too lazy to write many words.
 */

// ======================== Multiline arrow funtions ========================//

/**
 * The arrow functions that we’ve seen so far were very simple. They took arguments 
 * from the left of =>, evaluated and returned the right-side expression with them.
 * 
 ...
 *    statements inside the function, but we need an explicit return to return 
 *    something.
 *
